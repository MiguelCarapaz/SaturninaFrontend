  ...
  const Products3 = () => {
    ...
    const ShowProductDetails = ({ product }) => {
      ...
      const images = Array.isArray(product.imagen) && product.imagen.length > 1
      ? (
          ...
          <div className="card text-center h-100" style={productCardStyle}>
            ...
            <div className="card-body">
              <div className="buttons" style={{ justifyContent: "space-around" }}>
                <Link to={`/admin/product3/${product.id}`} className="btn btn-dark m-2" style={{ fontFamily: "Gotham, sans-serif", fontSize: "1rem" }}>
                  Ver
                </Link>
                <button className="btn btn-danger m-1" style={{ fontFamily: "Gotham, sans-serif", fontSize: "1rem" }} onClick={() => handleDelete(product.id)}>
                  Eliminar
                </button>
                <button className="btn btn-warning m-1" style={{ fontFamily: "Gotham, sans-serif", fontSize: "1rem" }} onClick={() => handleUpdate(product.id)}>
                  Actualizar
                </button>
              </div>
            </div>
