          ...
          {currentProducts.map((product) => {
            ...
            return (
              <div id={product.id} key={product.id} className="col-md-4 col-sm-6 col-xs-8 col-12 mb-4">
                <div className="card text-center h-100" style={productStyle}>
                  <img className="card-img-top p-3" src={product.image} alt="Card" style={{ height: "300px" }} />
                  ...
                  <div className="card-body">
                    <div className="buttons" style={buttonGroupStyle}>
                      <Link to={"/product/" + product.id} className="btn btn-dark m-2">
                        Ver
                      </Link>
                    </div>
                  </div>
